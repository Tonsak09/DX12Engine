...
Mesh::Mesh(Vertex vertices[], unsigned int indices[], int vertexCount, int indexCount, bool constructTangents)
	:indicesCount(indexCount), vertexCount(vertexCount)
{
...
void Mesh::CalculateTangents(Vertex* verts, int numVerts, unsigned int* indices, int numIndices)
{
	...
	for (int i = 0; i < numVerts; i++)
	{
		...
		tangent = DirectX::XMVector3Normalize(
			tangent - normal * DirectX::XMVector3Dot(normal, tangent)); // Value is repeated for each componenent apparently 
		// Store the tangent
...
/// <summary>
/// Get this mesh's vertex view 
/// </summary>
/// <returns></returns>
D3D12_VERTEX_BUFFER_VIEW Mesh::GetVertexView()
{
	return vbView;
}
/// <summary>
/// Get this mesh's index view 
/// </summary>
/// <returns></returns>
D3D12_INDEX_BUFFER_VIEW Mesh::GetIndexView()
{
	return ibView;
}
...
/// <summary>
/// Get how many indices are in this mesh 
/// </summary>
/// <returns></returns>
